...
export function Signup(){
    ...
    const createaccount = async()=>{
        try{
            if(firstname.length == 0 || lastname.length == 0 || password.length < 6 ||email.length == 0 ){
    ...
    return <div className="w-full h-full absolute overflow-hidden top-0 left-0">
        ...
        <div className="w-full p-5">
            ...
            <div className="">
                ...
                <input type="text" className="outline-2 p-2 border-2 w-full rounded-md text-sm font-normal" value={firstname} onChange={(e)=>{setFirstname(e.target.value)}}/>
            </div>

            <div className="">
                <div className="">Lastname Name </div>
                <input type="text"  className="outline-2 p-2 border-2 w-full rounded-md text-sm font-normal" value={lastname} onChange={(e)=>{setLastname(e.target.value)}}/>
            </div>
            ...
            <div className="w-full text-center">
                <button className="w-2/4 m-auto text-center bg-blue-500 p-2 mt-6 rounded-lg text-white" onClick={createaccount}>
                Sign up 
                </button>
                <div className="mt-2">
                    Already have an account ? <Link to='/signin' className="hover:underline text-blue-500">Signin</Link>
                </div>
            </div>
            </div>
        </div>
